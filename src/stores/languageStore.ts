...
const translations: Translations = {
  cn: {
    ...
    'theme.selectWallpaper': '选择壁纸',
    'theme.changeWallpaper': '更换壁纸',
    'theme.removeWallpaper': '移除壁纸',
    'theme.wallpaperPosition': '壁纸位置',
  ...
  en: {
    ...
    'theme.selectWallpaper': 'Select Wallpaper',
    'theme.changeWallpaper': 'Change Wallpaper',
    'theme.removeWallpaper': 'Remove Wallpaper',
    'theme.wallpaperPosition': 'Wallpaper Position',
